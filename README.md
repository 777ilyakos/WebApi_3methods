...
### Валидация:
- [x]	Дата не может быть позже текущей и раньше 01.01.2000
- [x]	Время не может быть меньше 0
- [x]	Значение показателя не может быть меньше 0
- [x]	Количество строк не может быть меньше 1 и больше 10 000
...
- [x]	По имени файла
- [x]	По времени запуска первой операции (от, до)
- [x]	По среднему показателю (в диапазоне)
- [x]	По среднему времени (в диапазоне)
...
+	Собранная программа не должна требовать настроек системы.
